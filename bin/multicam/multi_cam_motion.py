...
camMotion1 = BasicMotionDetector(accumWeight=0.5, deltaThresh=3, minArea=200)
camMotion2 = BasicMotionDetector(accumWeight=0.5, deltaThresh=5, minArea=5000)
total = 0


while True:
    # initialize list of frames that have been processed
    frames = []

    # loop over the frames and their motion detectors
